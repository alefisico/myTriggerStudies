#ifndef HLTHtLeadJetProducer_h_
#define HLTHtLeadJetProducer_h_
...
// Class declaration
class HLTHtLeadJetProducer : public edm::EDProducer {
  public:
    explicit HLTHtLeadJetProducer(const edm::ParameterSet & iConfig);
    ~HLTHtLeadJetProducer();
