...
for bin in ${ptBins[@]};
do
	namePythonFileCFI=QCD_Pt-${bin}_Tune4C_13TeV_pythia8_${PU}_v720pre8_Filt_cfi.py
...
myfilelist.extend(         [ " >> ${namePythonFileCFI}
	...
	for file in `ls -1 ${input_Dir}/QCD_Pt-${bin}_Tune4C_13TeV_pythia8/openHLT_Filt_triggerStudies_v720pre8_v2_QCD_Pt-${bin}_Tune4C_13TeV_pythia8_${PU}_Filt/${version}/*root`
