# /dev/CMSSW_7_4_0/HLT/V161 (CMSSW_7_4_1_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_7_4_0/HLT/V161')
)
...
process.datasets = cms.PSet( 
  ...
  InitialPD = ( cms.vstring( 'HLT_AK4CaloJet100_v1',
    'HLT_AK4CaloJet30_v1',
    'HLT_AK4CaloJet40_v1',
    'HLT_AK4CaloJet50_v1',
    'HLT_AK4CaloJet80_v1',
    ...
    'HLT_Mu8_TrkIsoVVL_Ele17_CaloIdL_TrackIdL_IsoVL_v1')+cms.vstring( 'HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v1',
...
process.hltHtMht4JetPt50 = cms.EDProducer( "HLTHtMhtProducer",
    usePt = cms.bool( False ),
...
process.hltPF4JetPt50HT750 = cms.EDFilter( "HLTHtMhtFilter",
    saveTags = cms.bool( True ),
...
if 'GlobalTag' in process.__dict__:
    ...
    #process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = 'PHYS14_25_V3')
    from Configuration.AlCa.GlobalTag_condDBv2 import GlobalTag as customiseGlobalTag
...
_customInfo['globalTag' ]= "PHYS14_25_V3"
