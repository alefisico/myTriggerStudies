...
process.hltAntiKT8PFJetsTrim = cms.EDProducer( "FastjetJetProducer",
    ...
    #src = cms.InputTag( "hltTrimPFJets" ),
    src = cms.InputTag( "hltParticleFlow" ),
    inputEtMin = cms.double( 0.0 ),
    puPtMin = cms.double( 10.0 ),
    srcPVs = cms.InputTag( "hltPixelVertices" ),
...
##### HT Triggers
process.HLT_HT450_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175OrHTT200 + process.hltPreHT450 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt450 + process.triggerPlotterHT + process.HLTEndSequence )
process.HLT_HT550_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175OrHTT200 + process.hltPreHT550 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt550 + process.HLTEndSequence )
...
process.HLT_HT750_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175OrHTT200 + process.hltPreHT750 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt750 + process.HLTEndSequence )
process.HLT_HT850_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175OrHTT200 + process.hltPreHT850 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt850 + process.HLTEndSequence )

######## PFNoPUHT Triggers
process.HLT_PFNoPUHT450_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFNoPUHT450 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt350 + process.HLTPFnoPUL1FastL2L3ReconstructionSequence + process.hltPFHTNoPU + process.hltPFHT450NoPU + process.triggerPlotterPFNoPUHT + process.HLTEndSequence )
process.HLT_PFNoPUHT550_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFNoPUHT550 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt450 + process.HLTPFnoPUL1FastL2L3ReconstructionSequence + process.hltPFHTNoPU + process.hltPFHT550NoPU + process.HLTEndSequence )
...
process.HLT_PFNoPUHT750_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFNoPUHT750 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt650 + process.HLTPFnoPUL1FastL2L3ReconstructionSequence + process.hltPFHTNoPU + process.hltPFHT750NoPU + process.HLTEndSequence )
process.HLT_PFNoPUHT850_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFNoPUHT850 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt750 + process.HLTPFnoPUL1FastL2L3ReconstructionSequence + process.hltPFHTNoPU + process.hltPFHT850NoPU + process.HLTEndSequence )


###### PFHT Triggers 
process.HLT_PFHT450_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFHT450 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt350 + process.HLTPFL1FastL2L3ReconstructionSequence + process.hltPFHT + process.hltPFHT450 + process.triggerPlotterPFHT + process.HLTEndSequence )
process.HLT_PFHT550_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFHT550 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt450 + process.HLTPFL1FastL2L3ReconstructionSequence + process.hltPFHT + process.hltPFHT550 + process.HLTEndSequence )
...
process.HLT_PFHT750_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFHT750 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt650 + process.HLTPFL1FastL2L3ReconstructionSequence + process.hltPFHT + process.hltPFHT750 + process.HLTEndSequence )
process.HLT_PFHT850_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFHT850 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt750 + process.HLTPFL1FastL2L3ReconstructionSequence + process.hltPFHT + process.hltPFHT850 + process.HLTEndSequence )

###### PFHTTrim Triggers 
process.HLT_PFHT450Trim_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFHT450Trim + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt350 + process.HLTPFL1FastL2L3ReconstructionSequence + process.hltAntiKT4PFJetsTrim + process.hltPFHT + process.hltPFHT450 + process.hlt1AK4PFJetsTrimMass00 + process.triggerPlotterPFHTTrim + process.HLTEndSequence )
process.HLT_PFHT550Trim_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFHT550Trim + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt450 + process.HLTPFL1FastL2L3ReconstructionSequence + process.hltAntiKT4PFJetsTrim + process.hltPFHT + process.hltPFHT550 + process.hlt1AK4PFJetsTrimMass00 + process.HLTEndSequence )
process.HLT_PFHT650Trim_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFHT650Trim + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt550 + process.HLTPFL1FastL2L3ReconstructionSequence + process.hltAntiKT4PFJetsTrim + process.hltPFHT + process.hltPFHT650 + process.hlt1AK4PFJetsTrimMass00 + process.HLTEndSequence )
process.HLT_PFHT750Trim_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFHT750Trim + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt650 + process.HLTPFL1FastL2L3ReconstructionSequence + process.hltAntiKT4PFJetsTrim + process.hltPFHT + process.hltPFHT750 + process.hlt1AK4PFJetsTrimMass00 + process.HLTEndSequence )
process.HLT_PFHT850Trim_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFHT850Trim + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt750 + process.HLTPFL1FastL2L3ReconstructionSequence + process.hltAntiKT4PFJetsTrim + process.hltPFHT + process.hltPFHT850 + process.hlt1AK4PFJetsTrimMass00 + process.HLTEndSequence )

process.HLT_PFTrimHT450_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFTrimHT450 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt350 + process.HLTPFL1FastL2L3ReconstructionSequence + process.hltAntiKT4PFJetsTrim + process.hltPFHT + process.hlt1AK4PFJetsTrimMass00 + process.hltPFHT450 + process.triggerPlotterPFTrimHT + process.HLTEndSequence )
process.HLT_PFTrimHT550_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFTrimHT550 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt450 + process.HLTPFL1FastL2L3ReconstructionSequence + process.hltAntiKT4PFJetsTrim + process.hltPFHT + process.hlt1AK4PFJetsTrimMass00 + process.hltPFHT550 + process.HLTEndSequence )
process.HLT_PFTrimHT650_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFTrimHT650 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt550 + process.HLTPFL1FastL2L3ReconstructionSequence + process.hltAntiKT4PFJetsTrim + process.hltPFHT + process.hlt1AK4PFJetsTrimMass00 + process.hltPFHT650 + process.HLTEndSequence )
process.HLT_PFTrimHT750_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFTrimHT750 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt650 + process.HLTPFL1FastL2L3ReconstructionSequence + process.hltAntiKT4PFJetsTrim + process.hltPFHT + process.hlt1AK4PFJetsTrimMass00 + process.hltPFHT750 + process.HLTEndSequence )
process.HLT_PFTrimHT850_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPrePFTrimHT850 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt750 + process.HLTPFL1FastL2L3ReconstructionSequence + process.hltAntiKT4PFJetsTrim + process.hltPFHT + process.hlt1AK4PFJetsTrimMass00 + process.hltPFHT850 + process.HLTEndSequence )


#### AK8 jets with AK4 JEC
...
process.HLT_AK8PFHT450_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFHT450 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt350 + process.HLTAK8PFL1FastL2L3ReconstructionSequence + process.hltAK8PFHT + process.hltAK8PFHT450 + process.triggerPlotterAK8PFHT + process.HLTEndSequence )
process.HLT_AK8PFHT550_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFHT550 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt450 + process.HLTAK8PFL1FastL2L3ReconstructionSequence + process.hltAK8PFHT + process.hltAK8PFHT550 + process.HLTEndSequence )
process.HLT_AK8PFHT650_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFHT650 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt550 + process.HLTAK8PFL1FastL2L3ReconstructionSequence + process.hltAK8PFHT + process.hltAK8PFHT650 + process.HLTEndSequence )
process.HLT_AK8PFHT750_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFHT750 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt650 + process.HLTAK8PFL1FastL2L3ReconstructionSequence + process.hltAK8PFHT + process.hltAK8PFHT750 + process.HLTEndSequence )
process.HLT_AK8PFHT850_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFHT850 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt750 + process.HLTAK8PFL1FastL2L3ReconstructionSequence + process.hltAK8PFHT + process.hltAK8PFHT850 + process.HLTEndSequence )


#### AK8 jets with AK4 JEC and TRIMMED
process.HLT_AK8PFTrimHT450_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFTrimHT450 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt350 + process.HLTAK8PFL1FastL2L3ReconstructionSequence + process.hltAntiKT8PFJetsTrim + process.hltAK8PFHT + process.hlt1AK8PFJetsTrimMass00 + process.hltAK8PFHT450 + process.triggerPlotterAK8PFTrimHT + process.HLTEndSequence )
process.HLT_AK8PFTrimHT550_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFTrimHT550 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt450 + process.HLTAK8PFL1FastL2L3ReconstructionSequence + process.hltAntiKT8PFJetsTrim + process.hltAK8PFHT + process.hlt1AK8PFJetsTrimMass00 + process.hltAK8PFHT550 + process.HLTEndSequence )
process.HLT_AK8PFTrimHT650_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFTrimHT650 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt550 + process.HLTAK8PFL1FastL2L3ReconstructionSequence + process.hltAntiKT8PFJetsTrim + process.hltAK8PFHT + process.hlt1AK8PFJetsTrimMass00+ process.hltAK8PFHT650  + process.HLTEndSequence )
process.HLT_AK8PFTrimHT750_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFTrimHT750 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt650 + process.HLTAK8PFL1FastL2L3ReconstructionSequence + process.hltAntiKT8PFJetsTrim + process.hltAK8PFHT + process.hlt1AK8PFJetsTrimMass00+ process.hltAK8PFHT750  + process.HLTEndSequence )
process.HLT_AK8PFTrimHT850_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFTrimHT850 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt750 + process.HLTAK8PFL1FastL2L3ReconstructionSequence + process.hltAntiKT8PFJetsTrim + process.hltAK8PFHT + process.hlt1AK8PFJetsTrimMass00 + process.hltAK8PFHT850 + process.HLTEndSequence )

process.HLT_AK8PFHT450Trim_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFHT450Trim + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt350 + process.HLTAK8PFL1FastL2L3ReconstructionSequence + process.hltAntiKT8PFJetsTrim + process.hltAK8PFHT + process.hltAK8PFHT450 + process.hlt1AK8PFJetsTrimMass00 + process.triggerPlotterAK8PFTrimHT + process.HLTEndSequence )
process.HLT_AK8PFHT550Trim_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFHT550Trim + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt450 + process.HLTAK8PFL1FastL2L3ReconstructionSequence + process.hltAntiKT8PFJetsTrim + process.hltAK8PFHT + process.hltAK8PFHT550 + process.hlt1AK8PFJetsTrimMass00 + process.HLTEndSequence )
process.HLT_AK8PFHT650Trim_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFHT650Trim + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt550 + process.HLTAK8PFL1FastL2L3ReconstructionSequence + process.hltAntiKT8PFJetsTrim + process.hltAK8PFHT + process.hltAK8PFHT650 + process.hlt1AK8PFJetsTrimMass00 + process.HLTEndSequence )
process.HLT_AK8PFHT750Trim_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFHT750Trim + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt650 + process.HLTAK8PFL1FastL2L3ReconstructionSequence + process.hltAntiKT8PFJetsTrim + process.hltAK8PFHT + process.hltAK8PFHT750 + process.hlt1AK8PFJetsTrimMass00 + process.HLTEndSequence )
process.HLT_AK8PFHT850Trim_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFHT850Trim + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt750 + process.HLTAK8PFL1FastL2L3ReconstructionSequence + process.hltAntiKT8PFJetsTrim + process.hltAK8PFHT + process.hltAK8PFHT850 + process.hlt1AK8PFJetsTrimMass00 + process.HLTEndSequence )

#### AK8 jets trimmed WITHOUT JEC
...
process.HLT_AK8PFNOJECHT450Trim_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFNOJECHT450Trim + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt350 + process.HLTAK8PFReconstructionSequence + process.hltAK8PFTrimHT + process.hltAK8PFTrimHT450  + process.hlt1AK8PFJetsTrimMass00 + process.triggerPlotterAK8PFNOJECHTTrim + process.HLTEndSequence )
process.HLT_AK8PFNOJECHT550Trim_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFNOJECHT550Trim + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt450 + process.HLTAK8PFReconstructionSequence + process.hltAK8PFTrimHT + process.hltAK8PFTrimHT550  + process.hlt1AK8PFJetsTrimMass00 + process.HLTEndSequence )
process.HLT_AK8PFNOJECHT650Trim_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFNOJECHT650Trim + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt550 + process.HLTAK8PFReconstructionSequence + process.hltAK8PFTrimHT + process.hltAK8PFTrimHT650  + process.hlt1AK8PFJetsTrimMass00 + process.HLTEndSequence )
process.HLT_AK8PFNOJECHT750Trim_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFNOJECHT750Trim + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt650 + process.HLTAK8PFReconstructionSequence + process.hltAK8PFTrimHT + process.hltAK8PFTrimHT750  + process.hlt1AK8PFJetsTrimMass00 + process.HLTEndSequence )
process.HLT_AK8PFNOJECHT850Trim_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFNOJECHT850Trim + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt750 + process.HLTAK8PFReconstructionSequence + process.hltAK8PFTrimHT + process.hltAK8PFTrimHT850  + process.hlt1AK8PFJetsTrimMass00 + process.HLTEndSequence )

process.HLT_AK8PFNOJECTrimHT450_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFNOJECTrimHT450 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt350 + process.HLTAK8PFReconstructionSequence + process.hltAK8PFTrimHT  + process.hlt1AK8PFJetsTrimMass00 + process.hltAK8PFTrimHT450 + process.triggerPlotterAK8PFNOJECTrimHT + process.HLTEndSequence )
process.HLT_AK8PFNOJECTrimHT550_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFNOJECTrimHT550 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt450 + process.HLTAK8PFReconstructionSequence + process.hltAK8PFTrimHT  + process.hlt1AK8PFJetsTrimMass00 + process.hltAK8PFTrimHT550 + process.HLTEndSequence )
process.HLT_AK8PFNOJECTrimHT650_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFNOJECTrimHT650 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt550 + process.HLTAK8PFReconstructionSequence + process.hltAK8PFTrimHT + process.hlt1AK8PFJetsTrimMass00  + process.hltAK8PFTrimHT650 + process.HLTEndSequence )
process.HLT_AK8PFNOJECTrimHT750_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFNOJECTrimHT750 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt650 + process.HLTAK8PFReconstructionSequence + process.hltAK8PFTrimHT  + process.hlt1AK8PFJetsTrimMass00 + process.hltAK8PFTrimHT750 + process.HLTEndSequence )
process.HLT_AK8PFNOJECTrimHT850_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreAK8PFNOJECTrimHT850 + process.HLTRecoJetSequenceAK4L1FastJetCorrected + process.hltHtMht + process.hltHt750 + process.HLTAK8PFReconstructionSequence + process.hltAK8PFTrimHT  + process.hlt1AK8PFJetsTrimMass00 + process.hltAK8PFTrimHT850 + process.HLTEndSequence )
