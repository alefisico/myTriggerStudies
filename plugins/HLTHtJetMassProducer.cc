...
//#include "HLTrigger/JetMET/interface/HLTHtJetMassProducer.h"
#include "MyTrigger/myTriggerStudies/interface/HLTHtJetMassProducer.h"
...
// Constructor
HLTHtJetMassProducer::HLTHtJetMassProducer(const edm::ParameterSet & iConfig) :
...
// Destructor
HLTHtJetMassProducer::~HLTHtJetMassProducer() {}

// Fill descriptions
void HLTHtJetMassProducer::fillDescriptions(edm::ConfigurationDescriptions & descriptions) {
    ...
    descriptions.add("hltHtJetMassProducer", desc);
}

// Produce the products
void HLTHtJetMassProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
DEFINE_FWK_MODULE(HLTHtJetMassProducer);
